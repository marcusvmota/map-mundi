...
;hljs.registerLanguage("bash",e)})();/*! `php` grammar compiled for Highlight.js 11.6.0 */
...
;hljs.registerLanguage("makefile",e)})();/*! `plaintext` grammar compiled for Highlight.js 11.6.0 */
(()=>{var t=(()=>{"use strict";return t=>({name:"Plain text",
aliases:["text","txt"],disableAutodetect:!0})})()
;hljs.registerLanguage("plaintext",t)})();/*! `shell` grammar compiled for Highlight.js 11.6.0 */
